...
def get_eer_stats(gen_scores, imp_scores, hformat=False, ds_scores=False):
    ...
    # print('fmr ', fmr)
    # print('fnmr', fnmr)
    # print('fmr1000', fmr1000, ind, len(fmr))
    # print('-->', fmr1000_th, np.sum(imp_scores > fmr1000_th))

    ind, fmr100 = get_fmr_op(fmr, fnmr, 0.01)
    fmr100_th = thrs[ind]
    # print('fmr100', fmr100, ind, len(fmr))
    # print('-->', fmr100_th, np.sum(imp_scores > fmr100_th))
