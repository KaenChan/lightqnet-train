...
def resface64(images, fc_inputs, keep_probability,
    ...
    net = slim.dropout(fc_inputs, keep_probability, is_training=phase_train, scope='Dropout')
...
def inference(image_batch, fc_inputs, embedding_size=256, keep_probability=1.0,
    ...
    with tf.variable_scope('Resface'):
        with slim.arg_scope([slim.conv2d, slim.fully_connected], 
            ...
            with slim.arg_scope([slim.conv2d], kernel_size=3):
                return resface64(image_batch, fc_inputs,
